...
const Policy = () => {
  ...
  return (
    <Layout title="Privacy Policy | gurukul.com">
      <div className="container text-center mb-5">
        <div className="info-container py-2 ">
          <div className="info-details">
            <h2>Privacy Policy</h2>
            <p>
              Gurukul.com ("we," "us," or "our") is committed to protecting the
              privacy of our users. This Privacy Policy outlines how we collect,
              use, disclose, and safeguard your information when you use our
              website (the "Site") and our services.
            </p>
            ...
            <h3>Contact Us</h3>
            <p>
              If you have any questions about this Privacy Policy, please mail
              us at gurukul.com@gmail.com, we will try to resolve you problem as
              soon as possible.
            </p>
          </div>
        </div>
