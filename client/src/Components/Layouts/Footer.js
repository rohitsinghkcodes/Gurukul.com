...
const Footer = () => {
  return (
    <footer className="text-center footer">
            ...
            <div className="col-md-6 col-xl-6 mx-auto mb-md-0 mb-4 ">
              ...
              <div className="row">
                <div className="col">
                  {" "}
                  <p className="f-link">
                    <IoHome /> &ensp;Bangalore, India
                  </p>
                  <p className="f-link">
                    <IoMdMail />
                    &ensp;gurukul@gmail.com
                  </p>
      ...
      >
        {"</> "}gurukul.com&ensp; | &ensp;All rights reserved &copy;
        <a style={{textDecoration:"none"}} href="https://github.com/rohitsinghkcodes"> rohitkcodes</a>
      </div>
    </footer>
  );
};
